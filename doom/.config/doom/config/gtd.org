#+TITLE: GTD Module
#+PROPERTY: header-args:emacs-lisp :tangle gtd.el

* GTD / Org Agenda
All GTD workflow configuration lives here:
- capture templates
- TODO workflow and metadata hooks
- org-gtd integration (capture  clarify  organize  engage  review)
- GTD keybindings
...
#+RESULTS:
| log-task-creation-time | log-todo-state-change |
