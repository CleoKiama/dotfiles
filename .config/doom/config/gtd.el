...
(use-package! org-gtd
  ...
  (setq org-gtd-directory my/org-gtd
        ;; Use a single archive policy via org-mode's org-archive-location.
        ;; This keeps org-gtd archiving consistent with the rest of org.
...
(map! :leader
      (:prefix-map ("d" . "GTD")
       :desc "Command center" ";" #'org-gtd-command-center
        :desc "Capture to inbox" "c" #'org-gtd-capture
        :desc "Clarify item at point" "k" #'org-gtd-clarify-item
        ...
        :desc "Reflect upcoming delegated" "u" #'org-gtd-reflect-upcoming-delegated
        ...
        :desc "Reflect completed projects" "P" #'org-gtd-reflect-completed-projects
