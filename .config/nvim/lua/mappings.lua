...
map("i", "jj", "<ESC>")
map("n", ";", ":", { desc = "[p] CMD enter command mode" })

-- Disable mappings default nvchad mappings
...
map("n", "<leader>u", vim.cmd.UndotreeToggle, { noremap = true, silent = true, desc = "[p] UndotreeToggle" })
